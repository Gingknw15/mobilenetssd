...
lineaccesstoken = 'hPBd1y6e5LTbCRlvQ7wSwtUsrlCEH6dapbjoKNW4Vxxz5Av3AqgyO7C/ZnienMg73Kx18x2sKrU9q1R2DqzyLPLcqmW0F2Pm0att2skgsv4jdN05mE2t3lRaWL8D3QKdSmuDfc53y20andkcuXZKSwdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี":
            replyObj = TextSendMessage(text="จ้า สวัสดีน้าบ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "มีหวานใจอะยัง":
            replyObj = TextSendMessage(text="ยังไม่มี")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "คุณแม่ให้มีหวานใจอะยัง":
            replyObj = TextSendMessage(text="ไม่รู้น้าบ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "covid" : 
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/d087c340-346c-497e-adbc-fb2c5ae3166a" 
